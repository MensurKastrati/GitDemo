...
import FrameworkParts.PageObjects.LandingPage;
...
public class StandAloneTest {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.id("userEmail")).sendKeys("mensurkastrati@gmail.com");
        driver.findElement(By.id("userPassword")).sendKeys("Men.jeta1");
